...
public class RClient
{
    ...
    private static string pathGetConnectionList = "GetConnectionListMethod";
    private static string pathGetCurrentSession = "GetCurrentSessionMethod";
    private static string pathCloseSession = "CloseSessionMethod";
    private static string pathPingRest = "PingRestMethod";
